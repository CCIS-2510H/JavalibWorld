...
class ExamplesKeyEvent {
    ...
    void testOnKeyEvent(Tester t) {
        ...
        t.checkExpect(nowPlayingOnKeyPress.contains(SoundConstants.BIRD_TWEET,
                new Note("G2n4")), true);
        t.checkExpect(nowPlayingOnKeyPress.contains(SoundConstants.BAGPIPE,
                new Note("E2f4")), true);
        t.checkExpect(nowPlayingOnKeyPress.contains(SoundConstants.BAGPIPE,
                new Note("C2n4")), true);
        t.checkExpect(nowPlayingOnKeyPress.contains(SoundConstants.CLARINET,
                new Note("B2n4")), true);
