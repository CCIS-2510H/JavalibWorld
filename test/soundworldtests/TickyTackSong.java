...
class Song implements SoundConstants, Iterable<Note> {
    ...
    Note[] tickyTackSong = new Note[] { this.g, this.a, this.e2, this.silent,
            this.c2, this.silent, // li-ttle bo-xes
            this.g, this.a, this.e2, this.silent, this.c2, this.silent, // on
                                                                        // the
                                                                        // hill
                                                                        // side
            this.g, this.g, this.cup, this.silent, this.cup, this.silent, // li-ttle
                                                                          // bo-xes
            this.cup, this.dup, this.eup, this.dup, this.cup2, this.silent, // made
                                                                            // of
                                                                            // ti-cky
                                                                            // ta-cky
            this.cup, this.a, this.g2, this.silent, this.g2, this.silent, // li-ttle
                                                                          // bo-xes
            this.g, this.a, this.f2, this.silent, this.f2, this.silent, // li-ttle
                                                                        // bo-xes
            this.f, this.g, this.e2, this.silent, this.e2, this.silent, // and
                                                                        // they
                                                                        // all
                                                                        // look
            this.e, this.f, this.d2, this.silent, this.silent, this.silent // just
                                                                           // the
                                                                           // same
    };
...
public class TickyTackSong extends World {
    ...
    int[] tickyTackTune = new int[] { 67, 69, 64, 0, 62, 0, 67, 69, 64, 0, 62,
            0, 67, 67, 72, 72, 72, 74, 76, 74, 72, 0, 72, 69, 65, 0, 65, 0, 67,
            69, 64, 0, 64, 0, 64, 0, 65, 0, 62, 0 };
    ...
    public void onTick() {
        ...
        // this.tickTunes.addTune(new Tune(TUBA, new
        // Note(this.tickyTackTune[(play++) % 48])));
        // this.tickTunes.addNote(TUBA, new Note(this.tickyTackTune[(play++) %
        // 48]));
    }
    ...
    public static ExamplesTickyTackSong examplesInstance = new ExamplesTickyTackSong();
}
...
class ExamplesTickyTackSong {
    ...
    void testMoveInBounds(Tester t) {
        ...
        t.checkExpect(this.cloud, new Cloud(new Posn(5, 100), 90, 60));
    }
    ...
    void testOnTick(Tester t) {
        ...
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("G4n1")),
                true);
        ...
        t.checkExpect(
                ...
                false);
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("A5n1")),
                true);
        ...
        t.checkExpect(
                ...
                false);
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("E4n2")),
                true);
        ...
        t.checkExpect(
                ...
                false);
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("E4n1")),
                true);
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("A0n0")),
                true);
        ...
        t.checkExpect(
                ...
                false);
        t.checkExpect(
                nowPlaying.contains(TickyTackSong.PIANO, new Note("C4n2")),
                true);
    ...
    void testOnMouseClicked(Tester t) {
        ...
        t.checkExpect(this.tworld, new TickyTackSong(new Cloud(
                new Posn(150, 80), 90, 60), this.sun));
