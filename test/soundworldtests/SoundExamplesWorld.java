...
class SoundWorldExamples implements SoundConstants {
    ...
    void testOnTick(Tester t) {
        ...
        t.checkExpect(initWorld.bloons, new ConsLoB(new Balloon(
                new Posn(50, 50), 40, new Red(), "Hap"), this.mtlob));
        ...
        t.checkExpect(initWorld.bloons, new ConsLoB(new Balloon(new Posn(150,
                50), 40, new Green(), "py"), new ConsLoB(new Balloon(new Posn(
                50, 50), 40, new Red(), "Hap"), this.mtlob)));
        ...
        t.checkExpect(initWorld.bloons, new ConsLoB(new Balloon(new Posn(250,
                50), 43, new Blue(), "Birth"), new ConsLoB(new Balloon(
                new Posn(150, 50), 40, new Green(), "py"),
                new ConsLoB(
                        new Balloon(new Posn(50, 50), 40, new Red(), "Hap"),
                        this.mtlob))));
        ...
        t.checkExpect(initWorld.bloons, new ConsLoB(new Balloon(new Posn(370,
                350), 40, new Green(), "you"), this.threeBloons));
        t.checkExpect(initWorld.tickTunes.bucketSize(), 2);
