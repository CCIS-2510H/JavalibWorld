 ...
 * 
 * <p>
 * MousePress moves the disk to its location
 * </p>
 * 
...
public class ExamplesSoundWorldTests extends World {
    ...
    public void onKeyEvent(String ke) {
        ...
        // turn the bottom line of the keyboard into a piano keyboard, one
        // octave up
        // play the middle C note
        if (ke.equals("z"))
            this.keyTunes.addNote(ORGAN, "C5n2");
    ...
    public static void main(String[] argv) {
        ExamplesSoundWorldTests ew = new ExamplesSoundWorldTests(new Posn(50,
                60));
        ExamplesSoundWorldTests ew2 = new ExamplesSoundWorldTests(new Posn(50,
                20));
