...
public class ExamplesTunesDemo implements SoundConstants {
    ...
    void testKeyboard(Tester t) {
        t.checkExpect(this.kb.keys.get(1), new Key(new Posn(43, 70), "s", "D",
                62));
        ...
        t.checkExpect(this.kb.keys.get(5), new Key(new Posn(135, 70), "h", "A",
                69));
    ...
    void testInstrumentBoard(Tester t) {
        // test the method that provides the NW corner of the selected choice
        // box
