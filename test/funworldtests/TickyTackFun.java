...
class ExamplesTickyTack {
     ...
     * 
     * boolean showWorld = c.show() && c.drawImage(this.wholeworld);
     */
    ...
    boolean testOnKeyEvent(Tester t) {
        return t.checkExpect(this.tworld.onKeyEvent(" "), new TickyTackFun(
                this.cloud, new Sun(28)))
                && t.checkExpect(new TickyTackFun(this.cloud, new Sun(28))
                        .onKeyEvent(" "), new TickyTackFun(this.cloud, new Sun(
                        1)))
