...
public class ExamplesImageDrawings {
    ...
    WorldImage combined = this.circleText.overlayImages(this.circle,
            this.diskText, this.disk, this.lineText, this.line,
            this.triangleText, this.triangle, this.ellipseText, this.ellipse,
            this.frameText, this.frame, this.ovalText, this.oval,
            this.rectangleText, this.rectangle, this.fromFileText, this.fish);
