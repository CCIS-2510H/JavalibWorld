...
/**
 * Applet wrapper for the WormWorld
 * 
 * @author Viera K. Proulx
 * @since March 7 2012
 */
public class WormWorldApplet extends WorldApplet {
    private static final long serialVersionUID = 3493567476129883870L;

    /** Produce a new WormWorld */
    public World getNewWorld() {
        return new WormWorld(new Worm(new Segment(50, 60, "up"),
