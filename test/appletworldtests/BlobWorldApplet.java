...
public class BlobWorldApplet extends WorldApplet {
    private static final long serialVersionUID = 6067865698563677727L;

    /** Produce a new BlobWorld */
    public World getNewWorld() {
        return new BlobWorld(new Blob(new Posn(50, 60), 20, new Red()));
    }
...
class BlobExamples {
    ...
    BlobWorld b1mouse50x50w = new BlobWorld(new Blob(new Posn(50, 50), 50,
            new Red()));

    BlobWorld bwOutOfBounds = new BlobWorld(new Blob(new Posn(100, 350), 50,
            new Red()));

    BlobWorld bwInTheCenter = new BlobWorld(new Blob(new Posn(100, 150), 50,
            new Red()));
    ...
    void reset() {
        ...
        this.b1mouse50x50w = new BlobWorld(new Blob(new Posn(50, 50), 50,
                new Red()));

        this.bwOutOfBounds = new BlobWorld(new Blob(new Posn(100, 350), 50,
                new Red()));

        this.bwInTheCenter = new BlobWorld(new Blob(new Posn(100, 150), 50,
                new Red()));
    }
    ...
    /** run the animation */
    BlobWorld w1 = new BlobWorld(new Blob(new Posn(100, 200), 20, new Red()));
    BlobWorld w2 = new BlobWorld(new Blob(new Posn(100, 200), 20, new Red()));
    BlobWorld w3 = new BlobWorld(new Blob(new Posn(100, 200), 20, new Red()));
