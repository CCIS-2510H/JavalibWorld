...
/**
 * A world that plays a piano keyboard, and plays a melody provided by a piano
 * roll, on the instrument selected by using mouse clicks.
 */
public class TunesWorld extends World {
    ...
    /**
     * The display of the list of available instruments that supports selection
     * of the current instrument using a mouse click
     */
    ...
    /**
     * On tick the piano roll plays the next chord - if it is in the playing
     * state.
     */
    public void onTick() {
     ...
     * <p>
     * <p>
     * The two bottom rows of character keys represent two octaves of white keys
     * on a piano and play the corresponding notes - using the currently
     * selected instrument.
     * <p>
     * <p>
     * The arrow keys are used to control the playing and stopping of the piano
     * roll:
     * <p>
     * <ul>
     * <li>right: play</li>
     * <li>left: play in reverse</li>
     * <li>up: stop, return to the start
     * <li>
     * <li>down: pause at the current place</li>
     * <ul>
     */
    public void onKeyEvent(String ke) {
        if (this.arrowKey(ke))
            ...
            if (this.numKey(ke)) {
                ...
                if (keyIndex != -1) {
                    this.keyTunes.addNote(this.instrument,
                            this.kb.playNote(keyIndex));
                }
            }
        }
    }
    ...
    protected boolean arrowKey(String ke) {
        return ke.equals("up") || ke.equals("down") || ke.equals("left")
                || ke.equals("right");
    }
    ...
    protected boolean numKey(String ke) {
        return ke.equals("1") || ke.equals("2") || ke.equals("3");
    }
     ...
     * 
     * @param keyIndex
     *            the index for key that has been released
     */
     ...
     * <code>InstrumentBoard</code> changes the current instrument to the
     * selected one.
     * 
     * @param pos
     *            the mouse position when the mouse click registered
     */
    ...
    public WorldImage makeImage() {
        WorldImage image = new RectangleImage(new Posn(300, 200), 600, 400,
                new White()).overlayImages(this.kb.keyboardImage(),
                this.ib.instrumentBoardImage(), this.pr.pianoRollImage());
        return image;
    }
}