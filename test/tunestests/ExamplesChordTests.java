...
public class ExamplesChordTests implements SoundConstants {
    ...
    /**
     * <p>
     * Test the method that produce a <code>String</code> representation of a
     * <code>Chord</code>.
     * </p>
     * 
     * @param t
    ...
    void testToStringMethods(Tester t) {
        ...
        t.checkExpect(this.cmajor1.toSimpleString(), "new Chord(C6n4, E6n2)");

        String expected = "new Chord(\n  " + this.C6n4.toIndentedString("    ")
    ...
    /**
     * <p>
     * Test all variants of the method <code>addNote</code>.
     * </p>
     * 
     * @param t
     *            the tester that runs the tests
    ...
    /**
     * <p>
     * Test all other method for the <code>Chord</code> class.
     * </p>
     * 
     * @param t
     *            the tester that runs the tests
