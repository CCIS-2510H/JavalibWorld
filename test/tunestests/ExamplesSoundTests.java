...
/**
 * <p>
 * Test suite for the <code>tunes</code> package.
 * </p>
 * <p>
 * Tests for the Note class, especially all of its constructors.
 * </p>
 * <p>
 * Tests for the MusicBox class.
 * </p>
 * <p>
 * Tests for the Tune and Chord classes.
 * </p>
 * 
...
public class ExamplesSoundTests implements SoundConstants {
    ...
    void testNoteConstruction(Tester t) {
        System.out.println("A4n1a pitch: " + this.A4n1a.pitch + " snote: "
                + this.A4n1a.snote + " octave: " + this.A4n1a.octave);
        System.out.println("A4n1b pitch: " + this.A4n1b.pitch + " snote: "
                + this.A4n1b.snote + " octave: " + this.A4n1b.octave);
    ...
    /**
     * <p>
     * Test the method sameNote in the class Note.
     * </p>
     * <p>
     * Test the methods nextBeat and skipBeat in the class Note.
     * </p>
     * 
     * @param t
     *            the tester that runs the tests
     */
    ...
    /**
     * <p>
     * Test the constructors for the Chord class.
     * </p>
     * <p>
     * Test the method addNote (all variants).
     * </p>
     * <p>
    ...
    int[] myInstrumentNames = new int[] { PIANO, ORGAN, TIMPANI, VIOLIN,
            CLARINET, STEELDRUM, CHOIR, TUBA, SAX, PERCUSSION, WOOD_BLOCK,
            BAGPIPE, BIRD_TWEET, SEASHORE, APPLAUSE, BRASS_SECTION };

    /** mapping of channels to the instruments they represent */
    int[] myInstruments = new int[] { Piano, ChurchOrgan, Timpani, Violin,
            Clarinet, SteelDrums, ChoirAahs, Tuba, AltoSax, PERCUSSION,
            Woodblock, BagPipe, BirdTweet, Seashore, Applause, BrassSection };
    ...
    /**
     * <p>
     * Test the constructors and methods for the class Tune
     * </p>
     * <p>
     * Test the methods isSilent, size, removeSilent, addNote, clearChord
     * addChord.
     * </p>
     * 
     * @param t
    ...
    void testTune(Tester t) {
        ...
        this.cmajorTune = new Tune(PIANO, new Chord(new Note("C6n4"), new Note(
                "E6n2")));
    ...
    /**
     * <p>
     * Test the constructors and methods for the class TuneBucket
     * </p>
     * <p>
     * Test the methods isSilent, size, removeSilent, addNote, clearChord
     * addChord.
    ...
    /**
     * Test that the constructor for MusicBox assigns the channels correctly.
     * 
     * @param t
     *            the tester that runs the tests
     */
