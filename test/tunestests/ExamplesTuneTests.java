...
public class ExamplesTuneTests implements SoundConstants {
    ...
    void testTune(Tester t) {
        ...
        t.checkExpect(this.cmajorTune.toString(), "Channel: 0"
                + "\n  note: C6n4 pitch: 84, duration: 4"
                + "\n  note: E6n2 pitch: 88, duration: 2\n**");

        t.checkExpect(this.cmajorTune.toIndentedString("  "), "Channel: 0"
                + "\n    note: C6n4 pitch: 84, duration: 4"
                + "\n    note: E6n2 pitch: 88, duration: 2\n**");
    ...
    /**
     * <p>
     * Test the methods <code>getChannel</code> and <code>contains</code>.
     * </p>
     * 
     * @param t
     *            the tester that runs the tests
    ...
    /**
     * <p>
     * Test the methods <code>isSilent</code> and <code>removeSilent</code>.
     * </p>
     * 
     * @param t
     *            the tester that runs the tests
