...
/**
 * <p>
 * Test suite for the <code>javalib.tunes</code> package.
 * </p>
 * <p>
...
public class ExamplesNoteTests implements SoundConstants {
    ...
    /**
     * <p>
     * Test the toString method for the class Note.
     * </p>
     * 
     * @param t
     */
    void testToString(Tester t) {
        t.checkExpect(this.C4n2.toString(), "new Note(\nthis.pitch = 60,"
                + "\nthis.duration = 2," + "\nthis.noteName = C,"
                + "\nthis.modifier = n," + "\nthis.octave = 4,"
                + "\nthis.snote = C4n2)\n*");
    }
    ...
    /**
     * <p>
     * Test the toIndentedString method for the class Note.
     * </p>
     * 
     * @param t
     */
    void testToIndentedString(Tester t) {
        t.checkExpect(this.C4n2.toIndentedString("  "), "new Note("
                + "\n  this.pitch = 60," + "\n  this.duration = 2,"
                + "\n  this.noteName = C," + "\n  this.modifier = n,"
                + "\n  this.octave = 4," + "\n  this.snote = C4n2)\n*");
    }
    ...
    /**
     * <p>
     * Test the method adjustPitch in the class Note.
     * </p>
     * 
     * @param t
     */
    ...
    /**
     * <p>
     * Test the various constructors in the class Note.
     * </p>
     * 
     * @param t
     */
