...
public class MarionWorldApplet extends WorldApplet {
    private static final long serialVersionUID = -8483669053059343464L;
...
class Marion extends World {
    ...
    public WorldImage makeImage() {
        return this.obstaclesImage().overlayImages(
    ...
    public WorldImage obstaclesImage() {
        WorldImage oImage = new RectangleImage(new Posn(100, 100), 200, 200,
                new White());
        for (int i = 0; i < 20; i++) {
            oImage = oImage.overlayImages(new RectangleImage(new Posn(
                    i * 10 - 10, 200 - this.obstacles.get(i) / 2), 20,
                    this.obstacles.get(i), new Black()));
        }
        return oImage;
    }
    ...
    public WorldImage lastImage(String s) {
        return this.makeImage().overlayImages(
                new TextImage(new Posn(150, 80), s, 13, 3, new Red()));
    }
