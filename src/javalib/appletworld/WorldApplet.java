 ...
 * @since 30 April, 2008, 18 June 2012
 * 
 */
abstract public class WorldApplet extends JApplet {
    private static final long serialVersionUID = 7267321591946492955L;
    ...
    // ///////////////////////////////////////////////////////////////////////
    /**
     * make sure FromFileImage knows we are working on an applet before any
     * files are read
     * 
     * @return always true
     */
    ...
    /**
     * implement this method if you want a different upper limit for your speed
     * control
     */
    ...
    // ///////////////////////////////////////////////////////////////////////
    /**
     * Initialize the width and height of the Canvas making sure the minimum
     * size is 200 x 200
     */
    ...
    protected void setSpeed(double d) {
        int n = ((Long) (Math.round(101 - d * SPEED_FACTOR * 100))).intValue();
    ...
    /**
     * Build the applet GUI: The Canvas panel on the top, the controls on the
     * bottom --- a buttom to start, stop, and clear; a slider to set the speed.
     */
    public void init() {
        ...
        // construct a new Canvas of the fixed size
        ...
        // BigBang button actions: START the world, STOP the world, CLEAR the
        // world
        ...
        // give the world a Canvas to draw on and a button for the end of the
        // world
    ...
    /**
     * <p>
     * The action for the world action control button. The button has three
     * states: CLEAR, RUNNING, and READY.
     * </p>
     * <p>
     * In READY state, the button is labeled "Start the world". The button press
     * starts the world and changes the state to RUNNING
     * </p>
     * <p>
     * In RUNNING state, the button is labeled "Stop the world". The world stops
     * either when the program stops the timer, or when the program ends the
     * world, or when the user hits the button. The button action changes the
     * state to CLEAR
     * </p>
     * <p>
     * In CLEAR state, the button is labeled "Clear the world". The final state
     * of the world with the appropriate message is still visible. The button
     * press clears the display and changes the state to READY.
     * </p>
     * 
     * @author Viera K. Proulx
    ...
    public class BigBangAction implements ActionListener {
         ...
         * </p>
         * <p>
         * The button switches to state of the applet between three states:
         * CLEAR, RUNNING, and READY.
         * </p>
         * 
         * <p>
         * READY state displays a cleared Canvas. The button label indicates
         * that the user can now <em>Start the world</em>. On activation it
         * invokes the <code>bigBang</code> method for this world, with the
         * speed given by the speed slider setting.
         * </p>
         * 
         * <p>
         * RUNNING state displays the running world. The button label indicates
         * that the user can <em>Stop the world</em> if so desired. On
         * activation of the button the currently running world is terminated
         * the state changes to CLEAR (see below). It allows the user to
         * interrupt an infinite loop that may have been erroneously encoded in
         * the program.
         * </p>
         * 
         * <p>
         * The change of state from RUNNING to CLEAR can also be triggered by
         * the program actions --- when the world ends.
         * 
         * <p>
         * CLEAR state displays the state of the world when the world ended. It
         * contains any message the program produced in the <code>endOfWorld
         * </p>
         * or
         * <p>
         * endOfTime
         * </p>
         * method, or it displays the message
         * <em>STOP button ended the world</em>.</p>
         * 
         * <p>
         * The button label indicates that the user can now <em>Clear the 
         * world</em>. On activation the Canvas panel is cleared (painted in
         * light gray color) and the state is changed to READY.
         * 
         * @param evt
         *            ignored, required by the <code>ActionListener</code>
         *            interface
         */
        public void actionPerformed(ActionEvent evt) {
            /*
             * Button labels for each state: String CLEAR = "CLEAR"; String
             * RUNNING = "STOP "; String READY = "START";
             */
            ...
            // process the READY state - change to RUNNING - if button pressed
                ...
                // start a new world, give it the canvas and button to stop the
                // game
                currentworld = getNewWorld();
                currentworld.initWorld(theCanvas, bigButton);
    ...
    /**
     * Process applet suspension: mark it stopped. If the world is currently
     * running, end the world, stop the timer and remove the key listener
     */
    public void stop() {
    ...
    /**
     * Draw the background for the entire applet panel in light gray color
     */
