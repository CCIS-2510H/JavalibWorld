...
public class AppletCanvas extends JPanel {
    private static final long serialVersionUID = 1363591306404224282L;
    ...
    /**
     * We must implement this method to make sure the canvas panel gets focus
     * when moused over - and responds to the key events appropriately.
     */
     ...
     * on the <code>{@link AppletCanvas Canvas}</code> at the given NW corner
     * 
     * @param imread
     *            the image maker for the image file
     * @param x
     *            the x coordinate for the image placement
     * @param y
     *            the y coordinate for the image placement
     */
     ...
     * 
     * <p>
     * As of 2.4.0, paints the internal paintable sequence of the buffered panel
     * after painting the buffered image.
     * </p>
     * 
     * @author Jeff Raab
    ...
    public static class Painter extends JPanel {
        private static final long serialVersionUID = -2789130306642867432L;
        /**
         ...
         * 
         * @param panel
         *            the <code>BufferedPanel</code> used to construct this
         *            <code>Painter</code>
         */
        ...
        /**
         * <p>
         * Paints the image buffer of the buffered panel in this panel and then
         * paints the buffered panel paintable sequence.
         * </p>
         * 
         * <p>
