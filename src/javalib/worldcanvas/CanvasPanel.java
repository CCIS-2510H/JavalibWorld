...
public class CanvasPanel extends JPanel {
     ...
     * width and height, and the given background color or <code>Paint</code>
     * for the image.
     * </p>
     * 
     * <p>
     * If the given width or height is less than 1 pixel, that value is set to 1
     * pixel.
     * </p>
     * 
     * <p>
     * Though the component itself may grow arbitrarily large, the buffered
     * image painted to the buffer will remain the size specified in this
     * constructor unless the size is reset using the <code>setBufferSize</code>
     * method.
     * </p>
     * 
     * @param width
     ...
     * internal buffered image for this panel.
     * </p>
     * 
     * <p>
     ...
     * 
     * <P>
     * Any image area gained by an size increase in either direction will be
     * painted with the current background color.
     * </P>
     * 
     * <P>
     * Any image area lost by a size decrease in either direction will be
     * clipped on the right and/or bottom of the image.
     * </P>
     * 
     * <P>
     * For a short time both the image of the previous size and an image of the
     * new size are maintained in memory.
     * </P>
     * 
     * @param width
    ...
    /**
     * <p>
     * Returns the internal panel for this buffered panel, that is, the panel
     * that paints the buffered image and handles the mouse and key adapters.
     * </p>
     * 
     * <p>
     * This panel may be used when access to the panel on which the graphics is
     * drawn is needed.
     * </p>
     * 
     * <p>
     * Do not set a border on this internal panel. Set a border on the outer
     * <code>BufferedPanel</code> object.
     * </p>
     * 
     * @since 1.1
     */
    ...
    /**
     * <p>
     * Fills this buffered panel with its background color or <code>Paint</code>
     * .
     * </p>
     */
    ...
    public void getFonts() {
        Graphics2D g = getBufferGraphics();
        Font f = g.getFont();
        System.out.println("Font is: " + f.getName() + " style = "
                + f.getStyle() + " size = " + f.getSize());
    }

    /**
     * <p>
     * Overrides to delegate to the inner panel that is the panel returned by
     * <code>getInnerPanel()</code>.
     * </p>
     */
    ...
    /**
     * <p>
     * Override this <code>paintOver</code> method to add additional painting
     * actions after the default buffer repaint is done during a
     * <code>repaint()</code> call.
     * </p>
     * 
     * <p>
     * The intention of this facility is to enable algorithmic painting to be
     * done via the <code>paintOver</code> method on top of the default painting
     * of the buffer image on the panel. This makes the buffer appear to be the
     * background and what is painted via the <code>paintOver</code> method to
     * be painted in the foreground.
     * </p>
     * 
     * <p>
     * The default implementation of the <code>paintOver</code> method is to do
     * nothing. This enables overrides as desired.
     * </p>
     * 
     * <p>
     * As of 2.4.0, this method is called after both the painting of the buffer
     * and the painting of the internal paintable sequence. Given the power
     * inherent in painting both the buffer bitmap and the internal paintable
     * sequence, it is rare that this method will need to be overridden.
     * </p>
     * 
     * @param g2
     *            the <code>Graphics2D</code> context for the buffer repaint
     *            operation
     * @since 1.0.1
     */
     ...
     * 
     * Copyright 2007 College of Computer and Information Science Northeastern
     * University Boston, MA 02115
     * 
     * The Java Power Tools software may be used for educational purposes as
     * long as this copyright notice is retained intact at the top of all source
     * files.
     * 
     * To discuss possible commercial use of this software, contact Richard
     * Rasala at Northeastern University, College of Computer and Information
     * Science, 617-373-2462 or rasala@ccs.neu.edu.
     * 
     * The Java Power Tools software has been designed and built in
     * collaboration with Viera Proulx and Jeff Raab.
     * 
     * Should this software be modified, the words "Modified from Original" must
     * be included as a comment below this notice.
     * 
     * All publication rights are retained. This software or its documentation
     * may not be published in any media either in whole or in part without
     * explicit permission.
     * 
     * This software was created with support from Northeastern University and
     * from NSF grant DUE-9950829.
     */

    /**
     * <p>
     * Panel that paints the internal buffered image that maintains the
     * persistent graphics state of the buffered panel.
     * </p>
     * 
     * @author Jeff Raab
    ...
    protected static class Painter extends JPanel {
         ...
         * 
         * @param panel
         *            the <code>CanvasPanel</code> used to construct this
         *            <code>Painter</code>
         */
         ...
         * 
         * <p>
         * Ignores any calls to <code>setPreferredSize</code>.
         * </p>
         */
        public Dimension getPreferredSize() {
            return new Dimension(panel.getBufferWidth(),
                    panel.getBufferHeight());
        }
        ...
        /**
         * <p>
         * Paints the component and then adds the work done by the paintOver
         * function.
         * </p>
         * 
         * <p>
    ...
    /**
     * <P>
     * Class <CODE>Refresh</CODE> encapsulates methods for graphics refresh.
     * </P>
     * 
     * <P>
     * Class <CODE>Refresh</CODE> cannot be instantiated.
     * </P>
     * 
     * @author Richard Rasala
     * @version 2.6.0c
    ...
    public static class Refresh {
         ...
         */
        private static Hashtable<Window, Window> windowHashtable = new Hashtable<Window, Window>();

        /**
         * <p>
         * Revalidates the given component, packs its parent window, and then
         * repaints the component.
         * </p>
         * 
         * <p>
         * As of 2.3.3, prevents indirect recursive calls to this method that
         * attempt to pack the same window object.
         * </p>
         * 
         * <p>
         * As of 2.6.0c, makes the parent window invisible, then packs, and then
         * makes the parent window visible.
         * </p>
         * 
         * @param component
