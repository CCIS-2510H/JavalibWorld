...
/**
 * Abstract Canvas - allows the drawing of shapes, lines, and text in the window
 * of the given size, window closing and re-opening.
 * 
...
public abstract class MyCanvas {
    ...
    /**
     * <P>
     * Construct a <code>MyCanvas</code> with the given width and height.
     * <P>
     * 
     * @param width
     *            the width of the panel
