...
abstract public class WorldApplet extends JApplet {
    private static final long serialVersionUID = -1287407265780005289L;
    ...
    protected void setSpeed(double d) {
        int n = ((Long) (Math.round(101 - d * SPEED_FACTOR * 100.0)))
                .intValue();
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            // invoked by button press or endOfWorld or endOfTime
                ...
                if (currentworld.worldExists == true) {
                    ...
                    // stop the timer, remove key listener, mark the world
                    // stopped
