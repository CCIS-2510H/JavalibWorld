...
/**
 * Copyright 2010 Viera K. Proulx This program is distributed under the terms of
 * the GNU Lesser General Public License (LGPL)
 * 
 * <p>
 * A class that represents one tune (a chord) to be played on the given channel.
 * </p>
 * <p>
 * The channel value is forced to be between 0 and 15, as we support only 16
 * channels.
 * </p>
 * 
...
public class Tune implements SoundConstants {
    ...
    /**
     * Add a note to this tune: make a new instance of the note so when it
     * plays, the original is untouched.
     * 
     * @param note
     *            the note to add
     */
    ...
    /**
     * Produce a readable representation of this tune or an empty
     * <code>String</code> if no chords are present
     * 
    ...
    public String toString() {
        ...
        /*
         * if (!this.chord.notes.isEmpty()){ String header = "Channel: " +
         * this.channel + "\n"; String notes = ""; for (Note n:
         * this.chord.notes){ notes = notes + "  note: " + n.snote + " pitch: "
         * + n.pitch + ", duration: " + n.duration + "\n"; } return header +
         * notes; } else return "";
         */
    }
    ...
    public String toIndentedString(String indent) {
        if (!this.chord.notes.isEmpty()) {
            ...
            for (Note n : this.chord.notes) {
                notes = notes + indent + "  note: " + n.snote + " pitch: "
                        + n.pitch + ", duration: " + n.duration + "\n";
            }
            return header + notes;
        } else
     ...
     * 
     * @param instrument
     *            the name of the instrument assigned to the channel played by
     *            this tune
     * @return a <code>String</code> that represents this tune
     */
     ...
     * 
     * @return true if there are no notes in the chord, or all have duration 0
     *         or less
     */
