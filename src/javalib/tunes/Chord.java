...
/**
 * <p>
 * A class to represent a collection of notes to be played on one instrument at
 * the same time.
 * </p>
 * <p>
 * Individual notes do not need to have the same duration.
 * </p>
 * 
...
public class Chord {
    ...
    /**
     * A constructor that creates a <code>Chord</code> from a sequence of
     * <code>String</code>s that represent notes to include in this chord.
     */
    ...
    /**
     * A constructor that creates a <code>Chord</code> from a sequence of
     * <code>int</code>s that represent notes to include in this chord.
     */
    ...
    /**
     * A constructor that creates a <code>Chord</code> from a sequence of
     * <code>Note</code>s to include in this chord.
     */
    ...
    /**
     * add a note to this chord, by converting its pitch and duration
     * representation
     */
    ...
    /**
     * EFFECT: reduce the duration of all notes in this chord by one and remove
     * all silent notes.
     * 
     * Produce the chord that represents the list of notes that have stopped
     * playing at the end of this beat.
     * 
    ...
    /**
     * <p>
     * EFFECT: increase the duration of all notes in this chord by one.
     * </p>
     * 
     * <p>
     * Produce this modified chord.
     * </p>
     * 
    ...
    /**
     * Is this <code>Chord</code> the same as the given one? They must contain
     * the same notes, but not necessarily in the same order. If some notes are
     * repeated, it does not matter. (It could be that this chord has AAD notes
     * and that chord has ADD notes, and we still think they are the same).
     * 
     * @param that
     *            the <code> Chord to compare this one with
     * @return true, if both chord have the same number of <code>Note</code>s,
     *         and every note that appears in one of them also appears in the
     *         other <code>Chord</code>
     */
     ...
     * 
     * @param indent
     *            the <code>String</code> of desired number of spaces
