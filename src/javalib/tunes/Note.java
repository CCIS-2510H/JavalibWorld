...
/**
 * <p>
 * A class to represent one note: its pitch and duration.
 * </p>
 * <p>
 * Automatic conversion to and from a <String> representation.
 * </p>
 * 
 * <p>
 * The <code>String Nomd</code> represents note <code>name</code> <em>N</em> in
 * the octave <em>o</em>, modified by <em>m</em>, of duration <em>d</em>, where
 * <ul>
 * <li>Note name --- one of <code>A B C D E F G</code></li>
 * <li>Note octave --- one digit: the octave on the keyboard</li>
 * <li>Modifier --- <strong>n</strong> natural, <strong>s</strong> sharp,
 * <strong>f</strong> flat</li>
 * <li>Duration --- the number of beats given as a number in the range from 1 to
 * 16</li>
 * </ul>
 * 
...
public class Note {
    ...
    /**
     * <p>
     * a representation of note names A a B C c D d E F f G g from the pitch.
     * Lower case letters denote note plus 'sharp' modifier.
     * </p>
     * <p>
     * The first note is 'E', as "E0" is a MIDI note 0 (unused)
     * </p>
     */
    private static Character[] noteNameMap = new Character[] { 'E', 'F', 'f',
            'G', 'g', 'A', 'a', 'B', 'C', 'c', 'D', 'd' };

    /**
     * the numeric value for <code>Character 'A'</code> to use in conversions
     */
    private static int charA = Character.getNumericValue('A');

    /**
     * <p>
     * A constructor that accepts a note given as its <code>MIDI</code> pitch
     * and duration in the number of beats (in the range from 1 to 16).
     * </p>
     * <p>
     * The fields that describe the note name, modifier, octave, as well as a
     * <code>String</code> representation of the note are initialized.
     * </p>
     * <p>
     * The constructor guarantees that the pitch and duration are valid.
     * </p>
     * 
     * @param pitch
     * @param duration
    ...
    /**
     * <p>
     * A constructor that accepts note description encoded as a
     * <code>String</code>.
     * </p>
     * <p>
     * The encoding consists of four or five characters, interpreted as follows:
     * 
     * <ul>
     * <li>Note name --- one of <code>A B C D E F G</code></li>
     * <li>Note octave --- one digit: the octave on the keyboard</li>
     * <li>Modifier --- <strong>n</strong> natural, <strong>s</strong> sharp,
     * <strong>f</strong> flat</li>
     * <li>Duration --- the number of beats given as a number in the range from
     * 1 to 16</li>
     * </ul>
     * 
     * <p>
     * for example <code>C6n4</code> represents a C natural, MIDI note 72, that
     * plays for 4 beats
     * </p>
     * 
     * @param snote
     *            The note encoding as a <code>String</code>
     */
     ...
     * 
     * @param snote
     *            the <code>String</code> representation of the note
     */
    private void initNote(String snote) {
        ...
        this.pitch = this.computePitch(this.noteName, this.octave,
                this.modifier);
    }

    /**
     * Make sure the note name is a valid note name. Set the invalid note name
     * to <code>'A'</code>.
     * 
     * @param noteName
     *            the given note name
    ...
    private Character adjustNoteName(char noteName) {
        if (noteName == 'A' || noteName == 'B' || noteName == 'C'
                || noteName == 'D' || noteName == 'E' || noteName == 'F'
                || noteName == 'G')
            return noteName;
        else
            return 'A';
    ...
    /**
     * Make sure the note modifier is a valid modifier. Set the invalid modifier
     * name to <code>'n'</code>.
     * 
     * @param mod
     *            the given modifier
    ...
    /**
     * Make sure the octave is a valid octave. Set the invalid octave name to
     * <code>'0'</code>.
     * 
     * @param oct
     *            the given octave
    ...
    void initNote(int pitch, int duration) {
        if (pitch == 0) {
            ...
            if (Character.isLowerCase(this.noteName)) {
                ...
                this.modifier = 'n';
            this.snote = "" + this.noteName + this.octave + this.modifier
                    + this.duration;
        }
    }
     ...
     * Note, for example, that <code>"E4s2"</code> is the same as
     * <code>"F4n2"</code> and <code>"G4s2"</code> is the same as
     * <code>"A4f2"</code>.
     * 
     * @param that
     *            the <code>Note</code> to compare with this one
    ...
    /**
     * Produce the representation of this <code>Note</code> as a
     * <code>String</code>
     */
    ...
    /**
     * Produce the representation of this <code>Note</code> as a
     * <code>String</code> indented as specified
     * 
     * @param indent
     *            a <code>String</code> of the desired number of spaces for
     *            indentation
