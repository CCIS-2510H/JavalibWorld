...
/**
 * <p>
 * A collection of constants to use when defining musical instruments and notes
 * to play with the tunes library.
 * </p>
 * <p>
 * The interface also defines the mapping between the channels and instruments
 * that is used to initialize the <code>MIDI</code> channels.
 * </p>
 * 
...
public interface SoundConstants {
    ...
    String[] instrumentNames = new String[] {
            ...
            // Synth Pad:
            "Pad1_newAge", "Pad2_warm", "Pad3_polysynth", "Pad4_choir",
            "Pad5_bowed",
            "Pad6_metallic",
            "Pad7_halo",
            "Pad8_sweep",
            ...
            // Synth Effects:
            "FX1_rain", "FX2_soundtrack", "FX3_crystal", "FX4_atmosphere",
            "FX5_brightness", "FX6_goblins",
            "FX7_echoes",
            "FX8_sci_fi",
    ...
    int[] instruments = new int[] { Piano, ChurchOrgan, Timpani, Violin,
