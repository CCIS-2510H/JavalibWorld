...
public class LineImage extends WorldImage {
    ...
    protected BoundingBox getBB(AffineTransform t) {
        Point2D end1 = WorldImage.transformPosn(t, -this.endPoint.x / 2, -this.endPoint.y / 2);
        Point2D end2 = WorldImage.transformPosn(t, this.endPoint.x / 2, this.endPoint.y / 2);
