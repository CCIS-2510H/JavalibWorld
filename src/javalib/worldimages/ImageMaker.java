...
/**
 * <p>
 * This class allows the user to read image data from a .png file and save it as
 * a <code>RenderedImage</code> in the format that is used for the
 * <code>World</code> when drawing on its canvas.
 * </p>
 * 
...
public final class ImageMaker {
    ...
    /**
     * Default constructor, so we can define a subclass that uses url for file
     * name - used by applets
     */
