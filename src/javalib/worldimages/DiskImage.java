...
/**
 * <p>
 * The class to represent filled disk images drawn by the world when drawing on
...
public class DiskImage extends WorldImage {
    ...
    public void draw(Graphics2D g) {
        ...
        g.setPaint(color);
        // draw the object
        g.fill(new Ellipse2D.Double(this.pinhole.x - radius, this.pinhole.y
    ...
    public WorldImage getMovedImage(int dx, int dy) {
        return new DiskImage(
                new Posn(this.pinhole.x + dx, this.pinhole.y + dy),
    ...
    public String toString() {
        return "new DiskImage(this.pinhole = (" + this.pinhole.x + ", "
